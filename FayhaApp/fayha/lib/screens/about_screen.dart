    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SectionHeader(eyebrow: 'Recognition', title: 'Achievements'),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            ChoirData.presidentName,
                            style: theme.textTheme.titleLarge,
                          ),
                          Text(
                            ChoirData.presidentTitle,
                            style: theme.textTheme.labelMedium?.copyWith(
                              color: AppColors.primary,
                            ),
                          ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            ChoirData.managerName,
                            style: theme.textTheme.titleLarge,
                          ),
                          Text(
                            ChoirData.managerTitle,
                            style: theme.textTheme.labelMedium?.copyWith(
                              color: AppColors.primary,
                            ),
                          ),
          ...
          const SectionHeader(eyebrow: 'Global', title: 'Affiliations'),
          const SizedBox(height: 16),
          ElegantCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                const SizedBox(height: 12),
                _AffiliationRow(
                  text: 'Collaborations with the European Choral Association',
                ),
                const SizedBox(height: 12),
                _AffiliationRow(
                  text:
