      ...
      body: BrandedBackground(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Avatar(name: member.name, size: 84, photoUrl: member.photoUrl),
          ...
          Builder(builder: (context) {
            ...
            final hoursTotal =
                member.practiceHours + (_liveRehearsals * 3);
            return Wrap(
              spacing: 10,
              runSpacing: 10,
              children: [
          ...
          if (hasHouse) ...[
            const SectionHeader(
                eyebrow: 'Location', title: 'House on the Map'),
            const SizedBox(height: 12),
            ElegantCard(
                  ...
                  ClipRRect(
                    ...
                    child: SizedBox(
                      ...
                      child: FlutterMap(
                        options: MapOptions(
                          initialCenter:
                              LatLng(member.houseLat!, member.houseLng!),
                          initialZoom: 15,
                          minZoom: 4,
                          maxZoom: 19,
                        ...
                        children: [
                          ...
                          MarkerLayer(
                            markers: [
                              Marker(
                                point: LatLng(
                                    member.houseLat!, member.houseLng!),
                                width: 40,
                                height: 40,
          ...
          // ----- Songs they know -----
          const SectionHeader(
              eyebrow: 'Repertoire', title: 'Songs They Know'),
          const SizedBox(height: 12),
          FutureBuilder<Set<String>>(
            ...
            builder: (context, snap) {
              ...
              return ElegantCard(
                child: Column(
                  children: knownSongs.map((s) => Padding(
          ...
          if (member.clothing.isNotEmpty) ...[
            const SectionHeader(
                eyebrow: 'Wardrobe', title: 'Clothing Inventory'),
            const SizedBox(height: 12),
            ElegantCard(
              child: Column(
